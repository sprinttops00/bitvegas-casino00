...
const TOKEN_PACKS = [
  { id: 'pack_500', name: 'Pack Starter', tokens: 500, gram: 0.1, emoji: '🪙', popular: false },
  { id: 'pack_1000', name: 'Pack Básico', tokens: 1000, gram: 0.2, emoji: '💰', popular: false },
  { id: 'pack_2500', name: 'Pack Popular', tokens: 2500, gram: 0.3, emoji: '💎', popular: true },
  { id: 'pack_5000', name: 'Pack Pro', tokens: 5000, gram: 0.5, emoji: '👑', popular: false },
  { id: 'pack_10000', name: 'Pack High Roller', tokens: 10000, gram: 1.0, emoji: '🚀', popular: false },
]
...
const BOOSTS = [
  {
    id: 'shield',
    name: 'Escudo Anti-Pérdida (un solo uso)',
    description: 'Salva el 100% de tu apuesta la próxima vez que pierdas. Se consume al usarse.',
    gram: 0.05,
    tokenPrice: 500,
    durationHours: 720,
    multiplier: 1.0,
  ...
  {
    id: 'shield_daily',
    name: 'Escudo Anti-Pérdida (Diario)',
    description: 'Salva el 100% de tu apuesta en TODAS las partidas que pierdas durante 24 horas. No se consume.',
    gram: 0.25,
    tokenPrice: 2500,
    durationHours: 24,
    multiplier: 1.0,
  ...
  {
    id: 'lucky_charm_legendary',
    name: 'Amuleto Legendario (+30% Win)',
    description: 'La versión más poderosa del amuleto: +30% de tokens extra en cada victoria durante 24 horas.',
    gram: 0.30,
    tokenPrice: 3000,
    durationHours: 24,
    multiplier: 1.30,
